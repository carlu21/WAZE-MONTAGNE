...
4. **Import de données officielles / partenaires** : arrêtés préfectoraux (risque incendie), fermetures de sentiers, calendriers de battues, open data ; comptes organisation multi-utilisateurs.
